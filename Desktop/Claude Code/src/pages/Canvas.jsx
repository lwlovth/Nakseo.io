        ...
        >
          ...
          <div className="flex gap-2">
            ...
            <button onClick={finishAndAnalyze}
              className={`${toolBtnBase} px-3 bg-primary-container text-on-primary-container sticker-shadow sticker-shadow-hover`}>
        ...
        <div className="max-w-6xl mx-auto px-6 py-10">
          ...
          <div className="flex justify-between items-end gap-6 mb-8">
            ...
            <div className="flex gap-4 shrink-0">
              <button onClick={saveToJournal}
                className="flex items-center gap-2 bg-surface-container-highest text-on-surface min-h-[48px] px-6 rounded-full font-bold sticker-shadow-hover transition-all">
                <span className="material-symbols-outlined">save</span>
                <span className="text-base">일기에 저장</span>
              </button>
              <button onClick={finishAndAnalyze}
                className="flex items-center gap-2 bg-primary-container text-on-primary-container min-h-[48px] px-8 rounded-full font-bold sticker-shadow sticker-shadow-hover transition-all">
